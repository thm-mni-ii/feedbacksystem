...
object SubmissionDBLabels {
  ...
  /** DB Label "submit_date" */
  val submit_date: String = "submit_date"

  /** DB Label "submission_data" */
  ...
  /** Label "evaluation" */
  val evaluation: String = "evaluation"

  /** Label "combined_passed" */
  val combined_passed: String = "combined_passed"
}
