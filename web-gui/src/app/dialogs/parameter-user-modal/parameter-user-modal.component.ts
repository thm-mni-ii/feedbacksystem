...
import {CourseParameter, CourseParameterUser} from "../../model/HttpInterfaces";

@Component({
  selector: 'app-parameter-user-modal',
  templateUrl: './parameter-user-modal.component.html',
  styleUrls: ['./parameter-user-modal.component.scss']
})
export class ParameterUserModalComponent implements OnInit {

  constructor(@Inject(MAT_DIALOG_DATA) public data: any, public dialogRef: MatDialogRef<ParameterUserModalComponent>, private db: DatabaseService) { }
