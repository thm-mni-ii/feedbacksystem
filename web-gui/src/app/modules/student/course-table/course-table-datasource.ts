...
const EXAMPLE_DATA: CourseTableItem[] = [
  {id: 'CS1020', name: 'Datenbanksysteme'},
  {id: 'CS1019', name: 'Compilerbau'},
  {id: 'CS1016', name: 'Programmierung interaktiver Systeme'},
  {id: 'CS1013', name: 'Objektorientierte Programmierung'}
];
