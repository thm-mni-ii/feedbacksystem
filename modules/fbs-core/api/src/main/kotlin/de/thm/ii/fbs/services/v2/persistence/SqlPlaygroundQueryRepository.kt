...
interface SqlPlaygroundQueryRepository : JpaRepository<SqlPlaygroundQuery, Int> {
    ...
    fun findByRunInCreatorIdAndRunInIdAndId(creatorId: Int, databaseId: Int, queryId: Int): SqlPlaygroundQuery?
    fun findByRunInCreatorIdAndRunInId(creatorId: Int, databaseId: Int): List<SqlPlaygroundQuery>
}
