...
alter table sql_playground_query add constraint FK65u5q1tv8i6y19g9cv8ygpyxe foreign key (run_in_id) references sql_playground_database (id) on update cascade ;
