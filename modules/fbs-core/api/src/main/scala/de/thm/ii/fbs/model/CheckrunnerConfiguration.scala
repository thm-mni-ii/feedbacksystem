...
case class CheckrunnerConfiguration(@JsonProperty checkerType: String,
                                    ...
                                    @JsonProperty var mainFileUploaded: Boolean = false,
                                    @JsonProperty var secondaryFileUploaded: Boolean = false,
                                    @JsonProperty var mainFileName: Option[String] = None,
                                    @JsonProperty var secondaryFileName: Option[String] = None,
                                    @JsonIgnore id: Int = 0,
