...
export const COMPLETION_PRESETS: Record<
  CompletionPreset,
  StudyAlgorithmConfig['completion']
> = {
  short: {
    minEvidencePerCompetency: 1,
    maxUncertainty: 0.85
  },
  balanced: {
    minEvidencePerCompetency: 2,
...
export function resolveStudyAlgorithmConfig(
  ...
  return {
    ...
    session: {
      ...DEFAULT_STUDY_ALGORITHM_CONFIG.session,
      ...overrides.session
    },
    completion: {
      ...DEFAULT_STUDY_ALGORITHM_CONFIG.completion,
