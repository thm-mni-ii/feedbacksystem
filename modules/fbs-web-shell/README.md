...
- **Iframe Host Container (`<fbs-app-host>`):** Full-height embedded application host with the PostMessage Bridge protocol (`FBS_INIT_HANDSHAKE`, `FBS_REQUEST_AUTH_TOKEN`, `FBS_NAVIGATE`, `FBS_SET_TITLE`, `FBS_ROUTE_CHANGED`, etc.).
