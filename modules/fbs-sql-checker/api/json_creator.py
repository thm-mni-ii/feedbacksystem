...
from table_checker import *
from pro_attribute_checker import *
...
def parseSingleStatUploadDB(data, client):
    ...
    if "submission" in data:
        ...
        extractedHaving = AWC.extract_having(data["submission"], client)
...
def insertTables(mydb, elem, my_uuid, client):
    ...
    if len(AWC.extract_having(elem["submission"], client)) == 1:
        ...
        mycollection = mydb["Having"]
        for val in AWC.extract_having(elem["submission"]):
